...
function SortableDroppableBubble({
  ...
  return (
    <div
      ...
      className={`relative flex h-8 shrink-0 cursor-grab select-none items-center gap-1.5 whitespace-nowrap rounded-full px-4 text-xs font-semibold transition-all duration-200 active:cursor-grabbing ${
        isActive
...
export function BubbleRow({
  ...
  return (
    <div
      ref={setZoneRef}
      className="flex w-full items-center gap-3 py-0 my-0"
    >
      <div
        ref={scrollRef}
